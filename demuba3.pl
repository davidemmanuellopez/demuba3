...
mkElegir(I2,A=M),putAtomo(I2,A=N),(!,elegir1(I2,A=N,PR,FX),\+(FX=(V=V)),
...
elegir1(I,A,P,XR2):- elegir(I,N),nth1(N,P,X),rs(X,XR,[A]),
...
loop:- mkIndex(I), loop1(I).
loop1(I):- write('loop'),cpIndex(I,I2),
indexarF(I2,p1 v p2=t),
rmIndex(I2),loop1(I).
